...
-----------------------
    c1_init     = 0.5    initial personal attraction
    c2_init     = 0.5    initial social attraction
...
# ── Best hyperparameters (determined by tune_pso.py sweep) ───────────────────
_DEFAULT_C1_INIT     = 0.5
_DEFAULT_C2_INIT     = 0.5
...
class PSOOperator(BaseOperator):
    ...
    c1_init : float
        Initial personal-attraction coefficient (default 0.5).
    c2_init : float
        Initial social-attraction coefficient (default 0.5).
    eta : float
    ...
    def reset(self) -> None:
        ...
        self._ptr[:]  = 0
        self._fill[:] = 0
        self.c1[:]    = _DEFAULT_C1_INIT
        self.c2[:]    = _DEFAULT_C2_INIT
